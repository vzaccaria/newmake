(function(){
  var glob, _, path, fs, shelljs, blessed, log, targets, deps, makefile, addToMakefile, addDeps, createTarget, createPhonyTarget, Box, parse, parseWatch, slice$ = [].slice, join$ = [].join;
  glob = require('glob');
  ...
  Box = (function(){
    ...
    prototype.toDir = function(dname, array){
      var obj, i$, len$, o;
