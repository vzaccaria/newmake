...
(function(){
  var _, glob, path, fs, shelljs, minimatch, debug, hdebug, targets, phonyTargets, deps, cleanTargets, notifyTargets, watchSources, notifyStripString, notifyRewrites, silent, command, makefile, EXPRESS_PORT, EXPRESS_ROOT, resetMakefile, addToMakefile, addDeps, error, Box, parse, watchSourceFiles, watchDestFiles, parseWatch, startExpress, LIVERELOAD_PORT, lr, startLivereload, notifyChange, moment, color, os, table, name, description, author, year, info, err, warn, src, otm, cwd, setupTemporaryDirectory, removeTemporaryDirectory, usageString, optimist, argv, ref$, slice$ = [].slice, join$ = [].join;
